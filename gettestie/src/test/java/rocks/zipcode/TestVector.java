...
public class TestVector {
    Vector<String> rockyOpponents;
    @Before
    public void setUp() throws Exception {
        rockyOpponents = new Vector<>();
    ...
    public void TestInsertElementAt() {
        rockyOpponents.insertElementAt("Thunderlips", 1);
        String actual = rockyOpponents.toString();
        assertEquals("[Apollo Creed, Thunderlips, Clubber Lang, Ivan Drago, Tommy Gun]", actual);
    }
